...
**"`Практическое применение Docker`"** - `Воскобойников Арсений Петрович`  
...
Скрин с версией докера прилагаю.  
...
``` 
**Ответ**   
Сделаем файл [**.dockerignore**](../.dockerignore) согласно заданию.   
Сделаем файл [**Dockerfile.python**](../Dockerfile.python) согласно заданию и проведем его проверку.
Проверка проходит корректно.  
<img src= "img/img_2.jpg" width="100%">   
Запустим приложение без использования docker.  
Создадим и активируем виртуальное окружение. Установим зависимости.  
<img src= "img/img_3.jpg" width="100%">
Запустим БД, настроим переменные окружения, запустим FastIP приложение локально.
<img src= "img/img_4.jpg" width="100%">
Приложение запустилось и всё работает
...
``` 
**Ответ**    
Сделаем файл [**compose.yaml**](../compose.yaml) согласно заданию.  
Запустим его, и проверим  работу.  

<img src= "img/img_6.jpg" width="100%">
Сделаем несколько запросов и посомтрим как они отобразились в базе:  
...
``` 
**Ответ**    
[Bash-скрипт](../deploy.sh) согласно заданию. Усложнил скрипт и он так же проводит установку docker compose на виртуальную машину.  
После запуск скачивается репозиторий из предидущего задания в папку /opt  
<img src= "img/img_8.jpg" width="100%">

Сделаем проверку работы севриса  

<img src= "img/img_9.jpg" width="100%">

а так же проверку приходящих запросов   

<img src= "img/img_10.jpg" width="100%">  

в логах видим, что все запросы от сервиса пришли:
...
``` 
**Ответ**   
Скачаем docker-образ Teraform  
<img src= "img/img_12.jpg" width="100%">  
...
<img src= "img/img_13.jpg" width="100%">  

 Распаковываем все слои и находим бинарный файл Terraform. Даем права бинарнику Terraform и проверяем версию. 

<img src= "img/img_14.jpg" width="100%">  
...
``` 
**Ответ**   
 Скачиваем контейнер, распаковываем, проверяем версию.
<img src= "img/img_15.jpg" width="100%">  
